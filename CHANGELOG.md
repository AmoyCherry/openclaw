...
- Gateway/Control UI: honor `gateway.auth.mode="trusted-proxy"` for Control UI websocket handshakes so trusted identity headers bypass device pairing instead of requiring `dangerouslyDisableDeviceAuth`.
